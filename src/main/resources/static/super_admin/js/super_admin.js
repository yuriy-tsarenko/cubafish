const productAPI = Vue.resource('/super_admin_auth/products/all');
const productAPISave = Vue.resource('/super_admin_auth/products/create');
const productAPIEditAndDelete = Vue.resource('/super_admin_auth/products/{id}');
const productCategoryApi = Vue.resource('/super_admin_auth/products/get_menu_categories');
const productCategoryApiGetSubCategories = Vue.resource('/super_admin_auth/products/get_sub_categories');
const productCategoryApiGetBrands = Vue.resource('/super_admin_auth/products/get_product_brands');
const productAPISorted = Vue.resource('/super_admin_auth/products/sorted_by_category');
const productAPISortedBySubCategory = Vue.resource('/super_admin_auth/products/sorted_by_sub_category');
const productAPISortedByBrand = Vue.resource('/super_admin_auth/products/sorted_by_brand');
const productAPISortedByTypeOfPurpose = Vue.resource('/super_admin_auth/products/sorted_by_type_of_purpose');
...
Vue.component('newProduct-row', {
    ...
    methods: {
        ...
        deleteProduct: function () {
            ...
            axios.post('/super_admin_auth/products/delete_product_image',
                formDataPath,
                {
                    headers: {
                        'Content-Type': 'multipart/form-data'
