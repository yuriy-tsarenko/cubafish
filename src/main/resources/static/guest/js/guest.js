...
Vue.component('newProduct-row', {
    ...
    template:
        '<div>' +
        '<table id="fromDb" style="width:1420px; height: 250px" >' +
        '<tr>' +
        ...
        '</tr>' +
        '<tr>' +
        '<td rowspan="3" style="alignment:center;vertical-align:center;width:200px">' +
        '<img v-on:click="hiddenFlag" style="width: 250px; height: 250px; border-radius:15%" :src="newProduct.productImageName" alt="photo"/>' +
        '</td>' +
        '<td rowspan="3" id="cellStyleDescription" style="width:400px; height:auto">' +
        '<div class="productValue" id="productValue1"><p><br/>{{newProduct.description}}<p></div>' +
        '</td>' +
        '<td rowspan="3" id="cellStyleSpecification" style="width:500px; height:auto">' +
        '<div class="productValue" id="productValue2"><p><br/>{{newProduct.specification}}<p></div>' +
        '</td>' +
        '<td id="cellStyle" style="width:270px; height:auto">' +
        ...
        '<input class="bigPhotoButton" type="button" value="Закрыть" v-on:click="this.show=!this.show">' +
        '</td>' +
        '</tr>' +
        '<tr>' +
        '<td>' +
        '<img style="width: 900px;height: 900px; border-radius:5%" :src="newProduct.productImageName" alt="photo"/>' +
        '</td>' +
        '</tr>' +
        '</table>' +
        '</div>' +
